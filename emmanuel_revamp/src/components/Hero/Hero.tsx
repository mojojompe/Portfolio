...
const Hero = () => {
  ...
  return (
    <header id="hero" className="hero-section" ref={heroRef}>
      <div className="hero-grid-bg" ref={bgRef} />
      ...
      <div className="hero-inner">
        ...
        <div className="hero-content" data-aos="fade-right" data-aos-duration="900">
          ...
          <h1 className="hero-name">
            JOMPE<br />
            <span className="hero-name-accent">EMMANUEL</span>
          </h1>
        ...
        {/* Right: Illustration */}
        <div className="hero-illustration" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200" ref={illustrationRef}>
          <div className="hero-illustration-wrapper">
            <img
              src="/hero-illustration.jpg"
              alt="Emmanuel coding at his desk — Corporate Memphis illustration"
              className="hero-illustration-img"
            />
            <div className="hero-float-badge hero-float-badge--1">
              <span className="float-badge-dot" style={{ background: '#22c55e' }} />
              <span>First Class · 4.86 / 5.0</span>
            </div>
      ...
      {/* Scroll indicator */}
      <a href="#about-me" className="hero-scroll-hint" aria-label="Scroll down">
